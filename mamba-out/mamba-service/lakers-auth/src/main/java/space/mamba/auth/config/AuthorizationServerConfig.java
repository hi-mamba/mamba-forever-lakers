package space.mamba.auth.config;
...
import org.springframework.security.oauth2.config.annotation.web.configuration.AuthorizationServerConfigurerAdapter;
import org.springframework.security.oauth2.config.annotation.web.configuration.EnableAuthorizationServer;
import space.mamba.auth.config.service.ClientDetailsServiceImpl;
import space.mamba.auth.config.service.UserDetailsServiceImpl;
import space.mamba.auth.domain.OAuthUserDetails;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public KeyPair keyPair() {
        KeyStoreKeyFactory factory = new KeyStoreKeyFactory(new ClassPathResource("mamba.jks"), "123456".toCharArray());
    ...
    public AuthenticationEntryPoint authenticationEntryPoint() {
        return (request, response, e) -> {
            ...
            DataResponse result = DataResponse.fail("FAIL");
